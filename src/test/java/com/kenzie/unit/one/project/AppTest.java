...
class AppTest {
     ...
     */
    @Test
    void command_get_returns_persons() {
        // GIVEN - create app
        ...
        // THEN
        assertTrue(result, "Expected result return true");
        //assertTimeout();
    }
    @Test
    ...
    void command_persons_add_person() {
        ...
        // WHEN
        when(handler.getString(anyString())).thenReturn(App.QUERY_PERSONS_COMMAND, App.CREATE_COMMAND,App.EXIT_COMMAND);
